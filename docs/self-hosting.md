...
**[auth-redesign.md → Liite A](auth-redesign.md)** (kohdat 1–4). Tee ne sieltä
...
(ks. auth-redesign.md Liite A, kohta 2).
...
Builds, root `tools/r2-auth-worker`) — ks. auth-redesign.md Liite B.
